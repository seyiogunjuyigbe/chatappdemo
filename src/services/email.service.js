...
module.exports = async (subject, to, body, link, linkText) => {
  const mailOptions = {
    to,
    from: `Chataway <${MAIL_SENDER}>`,
    subject,
            ...
            <td class="button">
              <div><!--[if mso
                ...
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                  <w:anchorlock/>
                  <center style="color:#ffffff;font-family Arial, sans-serif;font-size:14px;font-weight:regular;">${linkText}</center>
                </v:roundrect>
              <![endif
    ]--><a class="button-mobile" href="${link}"
